...
import static com.example.mediaplayer.activities.MusicActivity.al;
...
public class AlbumActivity extends AppCompatActivity implements OnClickListen {
    ...
    public void onClick(int position) {
        Intent intent=new Intent(MusicActivity.getInstance(), PlayerActivity.class).putExtra("index",position).putExtra("val",1).putExtra("from",true);
